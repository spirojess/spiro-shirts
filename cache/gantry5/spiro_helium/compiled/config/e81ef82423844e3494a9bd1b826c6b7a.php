...
return [
    ...
    'timestamp' => 1581544421,
    'checksum' => '1c708be8734a1974f4f4c3f57c12910e',
    'files' => [
        'user/data/gantry5/themes/spiro_helium/config/block_variations' => [
            'assignments' => [
                'file' => 'user/data/gantry5/themes/spiro_helium/config/block_variations/assignments.yaml',
                'modified' => 1581543184
            ],
            'index' => [
                'file' => 'user/data/gantry5/themes/spiro_helium/config/block_variations/index.yaml',
                'modified' => 1581543184
            ],
            'layout' => [
                'file' => 'user/data/gantry5/themes/spiro_helium/config/block_variations/layout.yaml',
                'modified' => 1581543184
            ]
        ],
        'user/data/gantry5/themes/spiro_helium/config/default' => [
            ...
            'page/body' => [
                'file' => 'user/data/gantry5/themes/spiro_helium/config/default/page/body.yaml',
                'modified' => 1581543184
            ],
            'particles/branding' => [
